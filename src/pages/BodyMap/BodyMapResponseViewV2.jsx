...
// ---- Page ------------------------------------------------------------------
export default function BodyMapResponseViewV2() {
      ...
      <Box sx={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', backgroundColor: 'var(--color-background-primary)' }}>
          <Box sx={{ flex: 1, p: 4, overflowY: 'auto' }}>
            ...
            {/* Model + confirmed selections */}
            <Box sx={{ display: 'flex', gap: 6, alignItems: 'flex-start', flexWrap: 'wrap', mt: 1 }}>
              {/* Body model (read-only) — centred in its column */}
              <Box sx={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                {/* Symptom layer toggle — tabs (only interactive control on the model) */}
                <Box sx={{ display: 'flex', justifyContent: 'center', mb: 1 }}>
                  <Tabs
                    value={activeLayer}
