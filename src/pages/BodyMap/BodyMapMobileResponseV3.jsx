    ...
    >
      {draft && (
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Live chip preview — display only, matches the chips below the model */}
          <Box sx={{ mb: 2 }}>
            ...
            <Chip
              ...
              label={`${draft.name} · ${draft.tab} · ${draft.severity}`}
              sx={{
                height: 36,
...
export default function BodyMapMobileResponseV3() {
