...
function SeveritySheet({ open, draft, onToggleSymptom, onSeverityChange, onAdd, onCancel, container }) {
    ...
    >
      {draft && (
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Live chip preview — one chip per selected symptom, display only, no label/dot */}
...
export default function BodyMapMobileResponseV7() {
