...
// Subtle per-symptom colour — the only place colour differentiation is used
const SYMPTOM_COLORS = {
  Pain: 'var(--color-error)',
  Stiffness: 'var(--color-warning)',
  Soreness: 'var(--color-primary)',
}
...
export default function BodyMapMobileResponseV6() {
    ...
    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', py: 4, px: 2, width: '100%' }}>
      ...
      >
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
          ...
          {/* Selected chips — single horizontally scrollable avatar row (Change 1) */}
          {committed.size > 0 && (
            <Box
              sx={{
                mt: 1,
                ...
                g.entries.map(([key, entry]) => (
                  ...
                  >
                    ...
                    <Box sx={{ position: 'relative', width: 48, height: 48 }}>
                      ...
                      {/* Symptom-type colour dot (bottom-right so it doesn't collide with the × at top-right) */}
                      <Box
                        sx={{
                          position: 'absolute',
                          bottom: 0,
                          ...
                          height: 12,
                          borderRadius: '50%',
                          backgroundColor: SYMPTOM_COLORS[entry.symptomType],
                          border: '2px solid var(--color-background-primary)',
                        }}
                      />
                    </Box>

                    {/* Truncated body part name */}
                    <Typography
                      variant="caption"
                      sx={{
                        mt: 0.5,
                    ...
                    {/* × dismiss — small visual, 44x44 hit area */}
                    <Box
                      component="button"
                      type="button"
                      aria-label="Remove"
